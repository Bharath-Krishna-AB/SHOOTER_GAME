...
class Soldier(pygame.sprite.Sprite):
    ...
    def move(self,moving_left,moving_right):
        ...
        dy = 0
         ...
         #assing movement vaiables if moving left or right
        if moving_left:
             dx = -self.speed
             self.flip = True
             self.direction = -1
        ...
        #check if going off the edeges of the screen
...
class Grenade(pygame.sprite.Sprite):
     ...
     def update(self):
          ...
          for tile in world.obstacle_list:
               ...
               if tile[1].colliderect(self.rect.x, self.rect.y + dy, self.width, self.height):
                    self.speed = 0
                    #check if below th ground, ie thrown up
                    if self.vel_y < 0:
                       self.vel_y = 0
                       dy = tile[1].bottom - self.rect.top
                    #check if above the ground, ie falling
...
class Explosion(pygame.sprite.Sprite):
     ...
     def update(self):
          ...
          if self.counter >= EXPLOSION_SPEED:
               self.counter = 0
               self.frame_index += 1
               #if the animation is completer then deleter the explosion
